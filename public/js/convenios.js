...
function mostrarConvenios(tipo, id) {
    axios.get("https://rrnnii.upea.bo/convenios/" + tipo + "/" + id).then(function (response) {
        ...
        detalles.forEach(convenio => {
            ...
            imagen.src = 'https://rrnnii.upea.bo' + convenio.img_convenio;
            ...
            pdf.href = 'https://rrnnii.upea.bo' + convenio.pdf_convenio;
