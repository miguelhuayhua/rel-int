...
@section('content')
    ...
    <main class="container my-5">
        ...
        <div class="row">
            <button class="btn" type="button" data-toggle="collapse" data-target="#mision"
                aria-expanded="false" aria-controls="collapseExample">
                <h3 class="collapse-title">Misión                 
                </h3>
            </button>
            ...
            <button class="btn" type="button" data-toggle="collapse" data-target="#vision"
                aria-expanded="false" aria-controls="collapseExample">
            ...
            <button class="btn" type="button" data-toggle="collapse" data-target="#lineas-accion"
                aria-expanded="false" aria-controls="collapseExample">
            ...
            data-target="#funciones-servicios"
                aria-expanded="false" aria-controls="collapseExample">
            ...
            <div class="collapse" id="funciones-servicios">
                <div class="ri-info">
                    <p>
                        ...
                        nuevos
                        instrumentos de cooperación. Impulsar el desarrollo de Proyectos de Investigación con instituciones
                        con
                        ...
                        relativas a ofertas de estudio en el extranjero. Asesorar a los estudiantes y docentes extranjeros
                        en
                        todo lo referente a su estadía en el país.
                    </p>
                </div>
            </div>
            <button class="btn" type="button" data-toggle="collapse" data-target="#objetivos" aria-expanded="false"
            ...
            <div class="collapse" id="objetivos">
                <div class="ri-info">
                    <ol>
                        <li>
                            <p>
                                Promover el fortalecimiento de las relaciones de la Universidad Pública de El Alto (UPEA),
                                con
                        ...
                        <li>
                            <p>
                                Fortalecer las actividades de investigación ciencia y tecnología a través de la realización
                                de
